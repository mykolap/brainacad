...
/**
 ...
 In this exercise, you will create a simple counting thread.
 It will count to 10, pausing one second between each number. Also, in keeping with the counting theme,
 it will output a string every ten numbers. 1. Create a class MyTimeBomb which extends the Thread class.
 2. Override the run() method of Thread.
 This is where the code will go that will output to console the numbers from 10 to 0 and after that prints “Boom!!!”.
 ...
 Add to method main() code that declares local variable bomb1 of MyTimeBomb type,
...
public class Lab1 {
    public static void main(String[] args) {
        Thread myTimeBomb = new MyTimeBomb();
        myTimeBomb.start();
    }
}
